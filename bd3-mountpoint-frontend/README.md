# bd3-mountpoint-frontend

> BD3 项目前端微服务模块 | 命名遵循《GitHub 微服务仓库命名规范 v1.1》  
> 对应后端服务：MS-09（挂载点管理）| 所属聚合仓库：BD-Upgrade-project

## 项目简介
NTRIP 挂载点生命周期/权限/数据源表的前端管理界面，对接 mountpoint-service。
...
- 后端端口：**18089**（经 vite 代理 `/api/v1/...` 转发）
