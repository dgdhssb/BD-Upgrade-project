# bd3-gateway-frontend

> BD3 项目前端微服务模块 | 命名遵循《GitHub 微服务仓库命名规范 v1.1》  
> 对应后端服务：MS-13（网关路由与鉴权）| 所属聚合仓库：BD-Upgrade-project

## 项目简介
BD3 微服务统一网关的前端探测界面，对接 gateway-service；页面直测各下游 /api/v1/*/health。
...
- 后端端口：**18080**（经 vite 代理 `/api/v1/...` 转发）
