# bd3-archive-frontend

> BD3 项目前端微服务模块 | 命名遵循《GitHub 微服务仓库命名规范 v1.1》  
> 对应后端服务：MS-10（数据归档）| 所属聚合仓库：BD-Upgrade-project

## 项目简介
数据归档/备份/恢复的前端管理界面，对接 archive-service（纯真实模式）。
...
- 后端端口：**18090**（经 vite 代理 `/api/v1/...` 转发）
