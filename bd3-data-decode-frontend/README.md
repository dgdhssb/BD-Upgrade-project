# bd3-data-decode-frontend

> BD3 项目前端微服务模块 | 命名遵循《GitHub 微服务仓库命名规范 v1.1》  
> 对应后端服务：MS-02（数据解码）| 所属聚合仓库：BD-Upgrade-project

## 项目简介
GNSS 原始码流解码（RTCM/RINEX/格式转换/二进制流/SSE）的前端界面，对接 data-decode-service。
...
- 后端端口：**18082**（经 vite 代理 `/api/v1/...` 转发）
