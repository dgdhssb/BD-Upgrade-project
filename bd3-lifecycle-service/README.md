# bd3-lifecycle-service

> BD3 项目微服务仓库 | 命名遵循《GitHub 微服务仓库命名规范 v1.1》  
> 对应服务：MS-11（数据生命周期服务）

## 项目简介
管理数据的生命周期策略（保留、转储、清理），与归档服务协同。
...
# 或
java -jar target/bd3-lifecycle-service.jar
```
> 默认端口：**18091**；服务自动注册至 Nacos 命名空间 `bd3`。
