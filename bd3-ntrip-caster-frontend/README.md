# bd3-ntrip-caster-frontend

> BD3 项目前端微服务模块 | 命名遵循《GitHub 微服务仓库命名规范 v1.1》  
> 对应后端服务：MS-08（NTRIP 播发）| 所属聚合仓库：BD-Upgrade-project

## 项目简介
NTRIP 播发服务（Netty TCP 2101）的前端管理界面，对接 ntrip-caster-service。
...
- 后端端口：**18088**（经 vite 代理 `/api/v1/...` 转发）
