# bd3-lifecycle-frontend

> BD3 项目前端微服务模块 | 命名遵循《GitHub 微服务仓库命名规范 v1.1》  
> 对应后端服务：MS-11（数据生命周期）| 所属聚合仓库：BD-Upgrade-project

## 项目简介
数据生命周期策略（保留/转储/清理）的前端管理界面，对接 lifecycle-service。
...
- 后端端口：**18091**（经 vite 代理 `/api/v1/...` 转发）
